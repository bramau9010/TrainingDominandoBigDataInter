...
END;
 EXPORT Dataset_raw := DATASET('~class::brayan::loan_status_2007-2020q3.gzip',Layout,CSV(HEADING(1)));
END;

//heading(1) olha a primeira linha sao os cabezalhos