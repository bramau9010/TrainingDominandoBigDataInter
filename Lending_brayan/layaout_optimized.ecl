EXPORT layaout_optimized := MODULE

EXPORT NewLayout1 := RECORD
    UNSIGNED3 field1;
    STRING40 id;
    UNSIGNED3 loan_amnt;
...
EXPORT Dataset_optimized1:= DATASET('~class::brayan_mauricio::loan_status_2007-2020q3.gzip',NewLayout1,CSV(HEADING(1)));
